 ...
 */
class MEDIAWIKI_EXPORT Upload : public Work
{
    Q_OBJECT
...
public:
    ...
    enum
    {
         ...
         */
        InternalError= Work::UserDefinedError+1,
        /**
...
public:
     ...
     */
    Upload(WPMediaWiki &mediawiki, QObject* const parent = 0);
...
private Q_SLOTS:
    ...
    void doWorkSendRequest(WikiPage page);
