...
class ParsePrivate : public WorkPrivate
{

public:

    ParsePrivate(WPMediaWiki& mediawiki)
...
Parse::Parse(WPMediaWiki& mediawiki, QObject* const parent)
    : Work(*new ParsePrivate(mediawiki), parent)
{
}
