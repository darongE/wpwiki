...
class QueryImagesPrivate : public WorkPrivate
{
public:

    QueryImagesPrivate(WPMediaWiki& mediawiki, const QString& limit)
...
QueryImages::QueryImages(WPMediaWiki& mediawiki, QObject* const parent)
    : Work(*new QueryImagesPrivate(mediawiki, QStringLiteral("10")), parent)
{
}
