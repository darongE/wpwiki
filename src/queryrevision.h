 ...
 */
class MEDIAWIKI_EXPORT QueryRevision : public Work
{
    Q_OBJECT
...
public:
    ...
    enum
    {
         ...
         */
        WrongRevisionId = Work::UserDefinedError + 1,
...
public:
     ...
     */
    explicit QueryRevision(WPMediaWiki &mediawiki, QObject* const parent = 0);
