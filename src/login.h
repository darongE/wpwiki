 ...
 */
class MEDIAWIKI_EXPORT Login : public Work
{
    Q_OBJECT
...
public:
    ...
    enum
    {
         ...
         */
        LoginMissing = KJob::UserDefinedError + 1,
...
public:
     ...
     */
    explicit Login(WPMediaWiki& mediawiki, const QString& login, const QString& password, QObject* const parent = 0);
