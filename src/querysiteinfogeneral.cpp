...
class QuerySiteInfoGeneralPrivate : public WorkPrivate
{

public:

    QuerySiteInfoGeneralPrivate(WPMediaWiki& mediawiki)
        : WorkPrivate(mediawiki)
    {
    }
};

QuerySiteInfoGeneral::QuerySiteInfoGeneral(WPMediaWiki& mediawiki, QObject* const /*parent*/)
    : Work(*new QuerySiteInfoGeneralPrivate(mediawiki))
{
}
