...
class QueryImageinfoPrivate : public WorkPrivate
{

public:

    QueryImageinfoPrivate(WPMediaWiki& mediawiki)
...
QueryImageinfo::QueryImageinfo(WPMediaWiki& mediawiki, QObject* const parent)
    : Work(*new QueryImageinfoPrivate(mediawiki), parent)
{
    Q_D(QueryImageinfo);
    Q_UNUSED(d);
}
