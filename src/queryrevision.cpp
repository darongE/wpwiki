...
class QueryRevisionPrivate : public WorkPrivate
{

public:

    QueryRevisionPrivate(WPMediaWiki& mediawiki)
...
QueryRevision::QueryRevision(WPMediaWiki& mediawiki, QObject* const parent)
    : Work(*new QueryRevisionPrivate(mediawiki), parent)
{
}
