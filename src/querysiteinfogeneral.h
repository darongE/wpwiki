 ...
 */
class MEDIAWIKI_EXPORT QuerySiteInfoGeneral : public Work
{
    Q_OBJECT
...
public:
    ...
    enum
    {
        IncludeAllDenied = Work::UserDefinedError + 1
    };
...
public:
     ...
     */
    explicit QuerySiteInfoGeneral(WPMediaWiki &mediawiki, QObject* const parent = 0);
