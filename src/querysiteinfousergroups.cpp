...
class QuerySiteinfoUsergroupsPrivate : public WorkPrivate
{
public:

    QuerySiteinfoUsergroupsPrivate(WPMediaWiki& mediawiki, QNetworkAccessManager* const manager, bool includeNumber)
...
QuerySiteinfoUsergroups::QuerySiteinfoUsergroups(WPMediaWiki& mediawiki, QObject* const parent)
    : Work(*new QuerySiteinfoUsergroupsPrivate(mediawiki, new QNetworkAccessManager(), false), parent)
{
}
